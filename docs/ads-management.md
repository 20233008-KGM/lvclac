...
| Pro (예정) | 결제 시 광고 제거 — [premium/features.md](./premium/features.md) |
...
- [ ] Pro 연동 시 `user.isPro` → `PageShell` / `AdSlot` 미렌더 ([premium/implementation.md](./premium/implementation.md))

## Pro·광고 제거 (예정)

로그인·결제 도입 시 Free는 현행 6슬롯, Pro는 광고 미노출. 상세: [premium/features.md](./premium/features.md), [login-integration.md](./login-integration.md).

### 가격 (확정안 — Pro $5 기준)

| 플랜 | USD | KRW (병행) | 광고 | Pro 기능 |
|------|-----|------------|------|----------|
| Free | $0 | 0원 | 6슬롯 | ✕ |
| Ad-Free (선택) | $3/월 · $29/년 | 2,500원 · 19,900원 | 제거 | ✕ |
| **Pro** | **$5/월 · $48/년** | 6,900원 · 49,900원 | 제거 | ○ |
| **Lifetime** | **$79** (1회) | 99,000원 | 제거 | ○ (영구) |

**Lifetime — 첫 출시 한정**

- **$79** = 월 $5 × 약 16개월. **v1 유료 오픈 시에만** 판매, 종료 후 **구독만**.
- 종료: 출시 기간 만료 또는 수량 상한(예: 50~100명) 도달 시 Stripe Product 비활성화.
- Stripe: Pro는 구독 Price, Lifetime은 **일회성 Payment** 별도 SKU.

상세 근거·Stripe 설정·환불: [premium/pricing.md](./premium/pricing.md)

## 관련 문서

- [premium/features.md](./premium/features.md) — Free vs Pro, 광고 슬롯
- [premium/implementation.md](./premium/implementation.md) — `isPro`·결제 로드맵
