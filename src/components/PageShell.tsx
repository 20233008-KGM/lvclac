...
export function PageShell({ children }: PageShellProps) {
  ...
  return (
    <div className="page-shell">
      {ADS_ENABLED && <aside className="ad-column ad-column-left" aria-label={t.ads.generic}>
      ...
      <div className="page-main">
        <div className="page-content">
          <ServiceDisclaimer />
          {children}
          {ADS_ENABLED && <div className="page-ads">
      ...
      {ADS_ENABLED && <aside className="ad-column ad-column-right" aria-label={t.ads.generic}>
