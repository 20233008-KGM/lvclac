  ...
  ko: {
    home: {
      ...
      paragraphs: [
        ...
        '지수·주식·원자재 선물의 단일 종목 포지션을 검토하는 참고용 도구입니다. 실제 청산 기준, 수수료와 반올림 방식은 거래소·증권사·브로커 규정을 함께 확인해야 합니다.',
      ],
      guideLink: '선물 청산가 계산기 사용법',
    ...
    formulas: {
      ...
      link: '선물 청산가 계산기 사용법 보기',
    },
    calculatorLink: '계산기로 돌아가기',
  },
  en: {
    home: {
      ...
      paragraphs: [
        ...
        'LiqGuard is a reference tool for reviewing a single index, equity, or commodity futures position. Always compare the result with the exchange, broker, or platform rules for liquidation, fees, and rounding.',
      ],
      guideLink: 'Futures liquidation calculator guide',
    ...
    formulas: {
      ...
      link: 'View the futures liquidation calculator guide',
    },
    calculatorLink: 'Back to calculator',
  },
} as const
