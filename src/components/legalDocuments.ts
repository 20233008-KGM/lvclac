...
const providerLinks = [
  ...
  { label: 'Microsoft Clarity', href: 'https://privacy.microsoft.com/privacystatement' },
    ...
    privacy: {
      ...
      sections: [operatorSection,
        { title: '1. 처리 목적·항목·보유기간', paragraphs: [
          ...
          ['분석·광고 성과', '페이지·리퍼러, 대략적 지역, 기기·브라우저, 이벤트·동의 상태, 허용 시 쿠키·광고 식별정보, 화면 이용 흐름·클릭·스크롤·세션 재생용 마스킹 데이터', '집계 방문 통계, 이용 현황·광고 성과 측정, 사용성 개선', '동의와 각 제공자의 보존 설정·정책에 따름. 철회 후 선택적 수집 중단; 이미 처리된 정보는 해당 삭제 절차 적용'],
        ] } },
        ...
        { title: '3. 처리위탁·외부 서비스와 제3자 제공', paragraphs: [
          ...
          ['Microsoft Clarity', '설정되고 분석을 허용한 경우 히트맵·스크롤맵·세션 재생', '페이지 이용 흐름, 클릭·스크롤, 대략적 기기·브라우저 정보 및 기본 마스킹된 화면 데이터'],
          ['PostHog', '설정되고 분석을 허용한 경우 제품 분석·퍼널·세션 재생', '익명 이벤트, 페이지 이용 흐름, 세션 재생용 입력 마스킹 데이터와 대략적 기기·브라우저 정보'],
        ...
        { title: '4. 국외 처리·보관', paragraphs: [
          ...
          ['Microsoft Clarity · 아래 개인정보 문의 경로', '미국 및 Microsoft 처리 거점', '클릭·스크롤·화면 이용 흐름, 세션 재생용 마스킹 데이터 / 분석 허용 후 페이지 이용 시 암호화 통신', '사용성 분석·히트맵·세션 재생 / Clarity 정책과 프로젝트 보존 설정에 따름'],
          ['PostHog · privacy@posthog.com', '미국 또는 선택한 PostHog 프로젝트 지역 및 하위처리자 운영 국가', '익명 이벤트, 페이지 이용 흐름, 세션 재생용 마스킹 데이터 / 분석 허용 후 페이지 이용 시 암호화 통신', '제품 분석·퍼널·세션 재생 / PostHog 정책과 프로젝트 보존 설정에 따름'],
        ...
        { title: '5. 쿠키·분석·광고와 선택권', paragraphs: [
          ...
          'Microsoft Clarity와 PostHog는 설정되어 있고 분석을 허용한 경우 클릭, 스크롤, 화면 이용 흐름, 퍼널과 세션 재생을 사용성 개선 목적으로 처리합니다. 계산 입력값을 이벤트 속성으로 보내지 않으며, 입력값은 마스킹되도록 구성합니다.',
        ...
        { title: '13. 방침 변경과 이번 개정', paragraphs: [
          ...
          '2026년 9월 26일: 상세 처리 항목·보관·국외 처리·권리 행사 안내를 복구하고 계정, 클라우드·메모·첨부, Paddle 결제, Google Ads 측정, Clarity·PostHog 사용성 분석 및 실제 삭제 동작을 반영했습니다.',
        ] },
      ],
    },
  }
    ...
    privacy: {
      ...
      sections: [operatorSection,
        { title: '1. Data, purposes and retention', paragraphs: [
          ...
          ['Analytics and ad measurement', 'Page/referrer, approximate location, device/browser, events, consent state, permitted cookie/ad identifiers, masked screen-flow, click, scroll and session-replay data', 'Aggregate traffic, usage, advertising performance measurement and usability improvement', 'According to consent and provider retention settings/policies. Withdrawal stops optional collection; previously processed data follows applicable deletion procedures'],
        ] } },
        ...
        { title: '3. Processors, external providers and disclosure', paragraphs: [
          ...
          ['Microsoft Clarity', 'Heatmaps, scroll maps and session replay when configured and analytics is allowed', 'Page-flow, clicks, scrolls, approximate device/browser information and masked screen data'],
          ['PostHog', 'Product analytics, funnels and session replay when configured and analytics is allowed', 'Anonymous events, page-flow, masked session-replay data and approximate device/browser information'],
        ...
        { title: '4. International processing and storage', paragraphs: [
          ...
          ['Microsoft Clarity · privacy contact in linked policy', 'United States and Microsoft processing locations', 'Clicks, scrolls, screen-flow and masked session-replay data; encrypted transfer when pages are used after analytics consent', 'Usability analytics, heatmaps and session replay; Clarity policy and project retention settings'],
          ['PostHog · privacy@posthog.com', 'United States or the selected PostHog project region and subprocessor locations', 'Anonymous events, page-flow and masked session-replay data; encrypted transfer when pages are used after analytics consent', 'Product analytics, funnels and session replay; PostHog policy and project retention settings'],
        ...
        { title: '5. Cookies, analytics, advertising and choices', paragraphs: [
          ...
          'Microsoft Clarity and PostHog process clicks, scrolls, screen-flow, funnels and session replay for usability improvement when configured and analytics is allowed. Calculator values are not sent as event properties, and input values are configured to be masked.',
        ...
        { title: '13. Changes to this policy', paragraphs: [
          ...
          'September 26, 2026: restored detailed data, retention, international processing and rights information and updated accounts, cloud notes/attachments, Paddle payments, Google Ads measurement, Clarity/PostHog usability analytics and actual deletion behavior.',
        ] },
      ],
    },
  }
