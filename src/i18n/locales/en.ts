  ...
  myPage: {
    ...
    billing: {
      ...
      page: {
        ...
        sandboxBody: 'Refresh the current Paddle state or end the test subscription immediately to rerun the Free-to-checkout flow.',
        sandboxSyncAction: 'Sync Paddle status',
        sandboxCancelNowAction: 'End test subscription now',
