...
export const en: Messages = {
  ...
  calculatorHistory: {
    ...
    diff: {
      ...
      orderPriceLink: 'Order price link',
      linked: 'Linked',
      unlinked: 'Unlinked',
  ...
  accountRecords: {
    ...
    memoFreeLimit: 'Free allows 1,000 characters per note. Existing longer notes are preserved and can be edited without increasing their length.',
    memoPasteLimit: 'You can paste up to 50,000 characters at once. Please paste in smaller portions.',
    memoRateLimit: 'Too many save requests. Please try again shortly. Your draft stays in this window.',
  ...
  myPage: {
    ...
    billing: {
      ...
      yearlyName: 'Yearly',
      yearlyPrice: '$48 / year',
      yearlyNote: '2 months off vs monthly',
      ...
      compareProSub: '· $48 / yr',
      freeFeaturesIncluded: ['Shows ads', 'One device set · one cloud set', '1,000 characters per note'],
      ...
      proFeatures: [
        ...
        'Unlimited note writing*',
      ],
      notePolicy: 'There is no length quota for ordinary personal note writing. Each paste supports up to 50,000 characters; save request frequency and automated bulk input may be restricted.',
      ...
      page: {
        ...
        yearlyBadge: '2 months off',
        yearlyCode: 'YEARLY',
        yearlyAmount: '$48',
        perYear: '/ yr',
        yearlyStrike: '$60',
        yearlyDesc: '2 months off vs monthly — about $4 / month.',
        ...
        upgrade: {
          ...
          billedYearly: 'Billed $48 / year · 2 months off',
          ...
          comparePro: 'Pro',
          compareRows: [
            { label: 'Note writing', free: '1,000 characters / note', pro: 'Unlimited*' },
          ...
          faq: [
            { q: 'What does unlimited note writing mean?', a: 'There is no length quota for ordinary personal note writing. Each paste supports up to 50,000 characters; save request frequency and automated bulk input may be restricted.' },
            {
          ...
          finalSublineYearly: '$48 / year · about $4 / month · 2 months off',
  ...
  welcome: {
    headerCta: 'New here?',
    headerCtaMeta: 'Examples',
    headerCtaAriaLabel: 'New here? Jump to calculation examples below',
