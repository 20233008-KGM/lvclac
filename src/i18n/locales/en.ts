...
export const en: Messages = {
  ...
  draftSave: {
    ...
    publicConsentBody: [
      'If you choose local saving, calculator inputs such as account equity, margin rates, and contract size are stored in this browser using localStorage.',
      'These values are not sent to our servers and can be restored on your next visit from this device.',
      'Saved information may be exposed on shared devices or through malware, browser extensions, or insecure environments. Please decide carefully whether to store account-related information.',
    ],
    publicConsentOff: "Don't save",
    publicConsentLocal: 'Save locally',
