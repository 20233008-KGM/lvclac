...
export const ko: Messages = {
  ...
  draftSave: {
    ...
    cloudHint:
      '# 클라우드에 입력값 저장\n로그인 중 클라우드를 선택하면 입력값이 Supabase DB에 저장되어 다른 기기에서도 불러올 수 있습니다. 끄면 클라우드 저장값만 삭제됩니다.\n\n────────\n\n[추천]\n\n💡 집 PC와 노트북에서 같은 기준값을 이어서 쓰기 좋습니다.',
    ...
    cloudEnableModalBody: [
      ...
      '비활성화 시 클라우드 저장값만 삭제됩니다. 이 기기 저장값은 이 기기 저장 모드에서 별도로 관리합니다.',
  ...
  legal: {
    ...
    termsArticles: [
      ...
      {
        title: '제4조 (입력값의 저장)',
        body: '계산기 입력값과 일부 화면 설정(패널 너비 등)은 저장 기능을 켠 경우에만 보관됩니다. 비로그인 사용자는 해당 기기의 브라우저 저장소(localStorage)에 저장되며, 로그인 사용자는 이 기기 저장 또는 클라우드 저장을 선택할 수 있습니다. 클라우드 저장을 켠 경우 입력값이 이용자 계정과 연결된 Supabase DB에 저장될 수 있습니다. 저장 기능을 끄면 현재 선택한 저장 위치의 입력값이 삭제됩니다.',
      },
      {
        title: '제5조 (광고)',
    ...
    privacyArticles: [
      {
        title: '1. 수집하는 정보',
        body: '계산기 입력값 및 화면 설정(패널 너비 등)은 저장 기능을 켠 경우에만 보관됩니다. 비로그인 사용자는 브라우저 저장소에 저장합니다. 로그인 사용자는 이 기기 저장 또는 클라우드 저장을 선택할 수 있으며, 클라우드 저장 선택 시 Supabase DB의 number_sets 데이터에 입력값이 저장될 수 있습니다. Google Analytics·AdSense 등을 설정한 경우 쿠키 및 접속 로그가 자동으로 수집될 수 있습니다.',
      },
      {
        title: '2. 이용 목적',
      ...
      {
        title: '3. 보관 및 처리',
        body: '입력값은 저장 기능을 켠 경우에만 보관됩니다. 이 기기 저장값은 이용자 기기에, 클라우드 저장값은 이용자 계정에 연결된 Supabase DB에 보관됩니다. 저장 기능을 끄면 현재 선택한 저장 위치의 저장값이 삭제됩니다.',
      },
      {
        title: '4. 제3자 제공',
      ...
      {
        title: '5. 이용자 권리',
        body: '저장 기능을 끄면 앱에서 보관 중인 입력값을 삭제할 수 있습니다. 비로그인 저장값은 브라우저 데이터 삭제로도 제거할 수 있으며, 로그인 클라우드 저장값 삭제 요청은 서비스 하단 문의 채널로 요청할 수 있습니다.',
      },
      {
        title: '6. 문의',
