...
export const ko: Messages = {
  ...
  marginMode: {
    ...
    perContract: '계약당',
    total: '총액',
    rateHint: '약정가치 대비 비율(증거금률)로 입력합니다. (국내 선물)',
    perContractHint:
      '1계약당 고정 증거금을 입력합니다. 총 증거금 = 계약당 금액 × 계약수. (해외 선물)',
  ...
  fields: {
    ...
    maintenanceMargin: {
      label: '유지증거금 (총액)',
      hint: 'HTS에 표시된 총 유지증거금. 계약수에 비례 조정',
      placeholder: '500,000',
    },
    maintenanceMarginPerContract: {
      label: '유지증거금 (계약당)',
      hint: '1계약당 고정 유지증거금. 가격이 변해도 고정 (해외 선물)',
      placeholder: '1,000',
    },
    entrustedMarginRate: {
      label: '개시증거금률 (위탁)',
      hint: '약정가치 대비 비율. 고정 금액은 계약당·총액 입력 사용',
      placeholder: 'ex) 0.35',
    },
    entrustedMargin: {
      label: '위탁증거금 (총액)',
      hint: 'HTS에 표시된 총 개시·위탁증거금. 계약수에 비례 조정',
      placeholder: '12,000',
    },
