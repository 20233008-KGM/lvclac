...
export const ko: Messages = {
  ...
  draftSave: {
    ...
    statusSaving: '저장 중',
    statusSavedLocal: '이 기기에 저장됨',
    statusSavedCloud: '클라우드에 저장됨',
  ...
  myPage: {
    ...
    linkedLoginBody: '이 계정에 연결된 로그인 수단입니다. Google을 연동하면 다음부터 Google로도 로그인할 수 있습니다.',
    emailProvider: '이메일 / 비밀번호',
    googleProvider: 'Google',
    providerLinked: '연동됨',
    providerNotLinked: '연동 안 됨',
    ...
    planStatusValue: '결제 연동 준비 중',
    planBody: 'Pro와 광고 제거는 별도 결제 연동 작업에서 제공됩니다. 현재 화면은 상태 확인 영역만 준비합니다.',
  ...
  guide: {
    title: '사용법',
    description:
      '입력 순서, 주문·시나리오 기능, 매일 시세 반영 루틴, 단축키를 정리했습니다.\nHTS에 표시된 숫자를 그대로 넣어 사용하세요.',
    sections: [
      {
        title: '시작하기',
        paragraphs: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          '매일 아침 HTS 시세만 시나리오 가격에 넣고 Enter → Enter 하면, 현재가와 평가금액이 손익 반영된 값으로 갱신됩니다.',
          '첫 Enter 후 HTS와 비교해 보세요.\n맞으면 두 번째 Enter로 확정, 틀리면 Esc 또는 Ctrl+Z로 되돌리세요.',
          '※ 이 루틴은 최초에 평가금·현재가를 맞춰 둔 뒤가 전제입니다.\n처음 세팅은 변동성이 낮을 때 하고, MTS는 시나리오 미리보기로 잔고 화면과 비교해 보세요.',
        ],
        items: [
          '포지션 수·종목이 바뀌지 않았을 때',
          '입출금·수수료·실현손익이 없을 때',
          '가격 변동(야간 갭 등)만 반영하면 될 때',
        ],
      },
      {
        title: '시나리오 가격',
        paragraphs: [
          '「매일 아침」 루틴의 핵심 도구입니다.',
          '시나리오 가격에 값을 넣고 Enter하면, 저장된 현재가·평가금액은 그대로 두고 결과만 해당 가격 기준으로 미리봅니다.',
      ...
      },
      {
        ...
        paragraphs: [
          ...
          '「매일 아침 빠르게 맞추기」와 함께 쓰면, 어제 맞춰 둔 계약수·증거금을 유지한 채 시나리오 가격으로 시세만 반영하기 좋습니다.',
        ],
      },
    ],
    footnote:
