...
export const ko: Messages = {
  ...
  welcome: {
    ...
    usageFirstBody: [
      '모든 칸을 채울 필요 없어요.',
      '계좌 평가금 · 현재가 · 계약수 · 계약승수 · 증거금만 넣으면 청산가가 바로 나와요.',
      '“추가 주문” 칸은 지금은 비워 두세요 — 이미 가진 포지션에 더할 때 쓰는 곳이에요.',
    ],
    usageNoneBody: [
      '진입 계획 값을 넣어 청산가를 미리 보세요.',
      '계좌 평가금 · 현재가 · 계약수 · 계약승수 · 증거금을 채우면 돼요.',
      '진입가를 넣으면 레버리지·약정가치도 함께 보여요. “추가 주문”은 비워도 됩니다.',
    ],
  ...
  fieldHint: {
    dismiss: '안내 닫기',
    firstTrade:
      '첫 거래라면 강조된 칸(계좌 평가금 · 현재가 · 계약수 · 계약승수 · 증거금)만 채우면 청산가가 나와요. 흐린 칸은 지금 몰라도 됩니다.',
    noPosition:
      '진입 계획 값을 강조된 칸에 넣어 청산가를 미리 보세요. “추가 주문”은 비워도 됩니다.',
    hasPosition:
